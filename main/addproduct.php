...
<span>Quantity : </span>
<input type="number" style="width:265px; height:30px; min:0; display:block;" id="txt11" onkeyup="sum();" name="qty" required><br>
...
<div style="float:right; margin-right:10px; display:block;">
    <button class="btn btn-success btn-block btn-large" style="width:267px; display:block;">
